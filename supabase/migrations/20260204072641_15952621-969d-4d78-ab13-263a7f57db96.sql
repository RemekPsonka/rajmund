-- Drop and recreate the simulation function with correct enum values
...
BEGIN
  ...
  -- Batches & Production flow - FIXED: Use 'Released' and 'Blocked' instead of 'available' and 'depleted'
  ...
  VALUES (v_raw_chicken_id, TO_CHAR(NOW(), 'YYMMDD') || '/KTF/001', 5000, 5000, 'Released', NOW()::date, (NOW() + INTERVAL '7 days')::date, v_storage_location_id) RETURNING id INTO v_raw_batch_id;
  ...
  INSERT INTO t_batches (product_id, internal_batch_number, current_quantity, initial_quantity, status, production_date, expiration_date, location_id) 
  VALUES (v_semi_meat_id, TO_CHAR(NOW(), 'YYMMDD') || '/KTF/002', 3000, 3000, 'Released', NOW()::date, (NOW() + INTERVAL '5 days')::date, v_storage_location_id) RETURNING id INTO v_meat_batch_id;
  
  INSERT INTO t_batches (product_id, internal_batch_number, current_quantity, initial_quantity, status, production_date, expiration_date, location_id) 
  VALUES (v_waste_bones_id, TO_CHAR(NOW(), 'YYMMDD') || '/KTF/003', 1900, 1900, 'Released', NOW()::date, (NOW() + INTERVAL '1 day')::date, v_storage_location_id) RETURNING id INTO v_bones_batch_id;
  ...
  INSERT INTO t_batches (product_id, internal_batch_number, current_quantity, initial_quantity, status, production_date, expiration_date, location_id) 
  VALUES (v_semi_masa_id, TO_CHAR(NOW(), 'YYMMDD') || '/KTF/004', 3300, 3300, 'Released', NOW()::date, (NOW() + INTERVAL '3 days')::date, v_storage_location_id) RETURNING id INTO v_masa_batch_id;
  ...
  INSERT INTO t_batches (product_id, internal_batch_number, current_quantity, initial_quantity, status, production_date, expiration_date, location_id) 
  VALUES (v_finished_kebab_15_id, TO_CHAR(NOW(), 'YYMMDD') || '/KTF/005', 3300, 3300, 'Released', NOW()::date, (NOW() + INTERVAL '90 days')::date, v_storage_location_id) RETURNING id INTO v_kebab_batch_id;
