...
BEGIN
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_gross, weight_tare, process_stage) VALUES (v_decomp_order_id, v_meat_batch_id, v_semi_meat_id, 3000, 0, 'Decomposition');
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_gross, weight_tare, process_stage) VALUES (v_decomp_order_id, v_bones_batch_id, v_waste_bones_id, 1900, 0, 'Decomposition');
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_gross, weight_tare, process_stage, recipe_id) VALUES (v_processing_order_id, v_masa_batch_id, v_semi_masa_id, 3300, 0, 'Massaging', v_recipe_id);
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_gross, weight_tare, process_stage, packaging_count, packaging_type) VALUES (v_assembly_order_id, v_kebab_batch_id, v_finished_kebab_15_id, 3400, 100, 'Stacking', 220, 'Słupek 15kg') RETURNING id INTO v_assembly_log_id;
  ...
  INSERT INTO t_production_logs (production_order_id, source_batch_id, output_batch_id, product_id, weight_gross, weight_tare, process_stage, freezing_started_at, freezing_completed_at, freezing_duration_minutes) VALUES (v_freezing_order_id, v_kebab_batch_id, v_kebab_batch_id, v_finished_kebab_15_id, 3400, 100, 'Freezing', NOW() - INTERVAL '4 hours', NOW(), 240);

  FOR v_i IN 1..5 LOOP
    INSERT INTO t_handling_units (company_id, facility_id, sscc_number, type, status, total_net_weight, items_count, production_date, label_printed) VALUES (v_company_id, v_facility_id, '0059' || LPAD(v_i::text, 16, '0'), 'Pallet', 'Closed', 660, 44, NOW()::date, true) RETURNING id INTO v_pallet_id;
