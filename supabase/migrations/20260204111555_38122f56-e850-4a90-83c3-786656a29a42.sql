-- Fix simulate_full_production_day: 'shipped' -> 'Shipped'
...
BEGIN
  ...
  -- ETAP 1: PRZYJĘCIE SUROWCA (5000 kg)
  ...
  -- Output odpady (38% odpady + 2% straty)
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, weight_gross, process_stage) VALUES (v_decomp_order_id, v_meat_batch_id, v_semi_meat_id, 3000, 3000, 'Rozbiór');
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, weight_gross, process_stage) VALUES (v_decomp_order_id, v_bones_batch_id, v_waste_bones_id, 1900, 1900, 'Rozbiór-Odpady');

  -- ETAP 3: MASOWANIE/TUMBLING (Processing)
  ...
  -- 3000kg mięsa + 300kg przypraw (10%) = 3300kg masy
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, weight_gross, process_stage, recipe_id) VALUES (v_processing_order_id, v_masa_batch_id, v_semi_masa_id, 3300, 3300, 'Masowanie', v_recipe_id);

  -- ETAP 4: SKŁADANIE KEBABÓW (Assembly)
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, weight_gross, process_stage, packaging_count, packaging_type) VALUES (v_assembly_order_id, v_kebab_batch_id, v_finished_kebab_15_id, 3300, 3400, 'Składanie', 220, 'Słupek 15kg') RETURNING id INTO v_assembly_log_id;
  ...
  -- ETAP 5: MROŻENIE SZOKOWE (Freezing)
  ...
  INSERT INTO t_production_logs (production_order_id, source_batch_id, output_batch_id, product_id, weight_net, weight_gross, process_stage, freezing_started_at, freezing_completed_at, freezing_duration_minutes) VALUES (v_freezing_order_id, v_kebab_batch_id, v_kebab_batch_id, v_finished_kebab_15_id, 3300, 3400, 'Mrożenie szokowe', NOW() - INTERVAL '4 hours', NOW(), 240);

  -- ETAP 6: PALETYZACJA (5 palet)
  FOR v_i IN 1..5 LOOP
  ...
  -- ETAP 7: WYSYŁKA (status: 'Shipped' z wielką literą)
