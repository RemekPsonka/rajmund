...
-- Drop and recreate with CORRECT enum values
...
BEGIN
  ...
  IF v_uom_kg_id IS NULL THEN
    INSERT INTO t_units_of_measure (name, symbol, type) VALUES ('Kilogram', 'kg', 'Weight') RETURNING id INTO v_uom_kg_id;
  END IF;
  
  -- Company (correct schema)
  INSERT INTO t_companies (name, short_name, tax_id, is_active, main_address_json)
  VALUES ('Kebab Test Factory', 'KTF', 'PL1234567890', true, '{"street": "ul. Testowa 1", "city": "Warszawa"}'::jsonb)
  RETURNING id INTO v_company_id;
  
  -- Facility (correct enum: Plant, Warehouse, Office, Store)
  INSERT INTO t_facilities (company_id, name, type, vet_approval_number)
  VALUES (v_company_id, 'Zakład Produkcyjny Kebab', 'Plant', 'PL12345678')
  ...
  -- Products
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Ćwiartka kurczaka klasy A', 'SU-KURCZAK-001', 'RawMeat', v_uom_kg_id, true) RETURNING id INTO v_raw_chicken_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Mięso z kurczaka (po rozbiorze)', 'PP-MIESO-001', 'SemiFinished', v_uom_kg_id, true) RETURNING id INTO v_semi_meat_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Masa kebabowa masowana', 'PP-MASA-001', 'SemiFinished', v_uom_kg_id, true) RETURNING id INTO v_semi_masa_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Kebab Drobiowy 10kg', 'KEB-DRB-10', 'FinishedGood', v_uom_kg_id, true) RETURNING id INTO v_finished_kebab_10_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Kebab Drobiowy 15kg', 'KEB-DRB-15', 'FinishedGood', v_uom_kg_id, true) RETURNING id INTO v_finished_kebab_15_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Kebab Drobiowy 20kg', 'KEB-DRB-20', 'FinishedGood', v_uom_kg_id, true) RETURNING id INTO v_finished_kebab_20_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Kości drobiowe', 'ODP-KOSCI-001', 'Waste', v_uom_kg_id, true) RETURNING id INTO v_waste_bones_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Mix przypraw kebab', 'PRZ-MIX-001', 'Spice', v_uom_kg_id, true) RETURNING id INTO v_spice_mix_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Woda technologiczna', 'DOD-WODA-001', 'Additive', v_uom_kg_id, true) RETURNING id INTO v_additive_water_id;
  INSERT INTO t_products (company_id, name, sku, industry_category, base_unit_id, is_active) VALUES (v_company_id, 'Białko sojowe', 'DOD-BIALKO-001', 'Additive', v_uom_kg_id, true) RETURNING id INTO v_additive_protein_id;

  -- Recipe (SemiFinished -> SemiFinished)
  ...
  VALUES (v_company_id, 'Masa kebabowa standard', v_semi_meat_id, v_semi_masa_id, 110, 0, 'Receptura masy kebabowej z mięsa drobiowego', true)
  RETURNING id INTO v_recipe_id;
  
  INSERT INTO t_recipe_ingredients (recipe_id, product_id, amount_per_kg_base, unit) VALUES (v_recipe_id, v_spice_mix_id, 0.015, 'kg');
  INSERT INTO t_recipe_ingredients (recipe_id, product_id, amount_per_kg_base, unit) VALUES (v_recipe_id, v_additive_water_id, 0.080, 'kg');
  INSERT INTO t_recipe_ingredients (recipe_id, product_id, amount_per_kg_base, unit) VALUES (v_recipe_id, v_additive_protein_id, 0.005, 'kg');

  -- Stage 1: Raw material (PZ)
  INSERT INTO t_batches (product_id, internal_batch_number, supplier_batch_number, current_quantity, initial_quantity, status, production_date, expiration_date, location_id)
  VALUES (v_raw_chicken_id, TO_CHAR(NOW(), 'YYMMDD') || '/KTF/001', 'SUP-2024-12345', 5000, 5000, 'available', (NOW() - INTERVAL '1 day')::date, (NOW() + INTERVAL '7 days')::date, v_storage_location_id)
  RETURNING id INTO v_raw_batch_id;

  -- Stage 2: Decomposition (60% yield)
  INSERT INTO t_production_orders (company_id, facility_id, order_number, type, status, production_date, notes)
  VALUES (v_company_id, v_facility_id, 'ROZ/' || TO_CHAR(NOW(), 'YYMMDD') || '/001', 'Decomposition', 'Closed', NOW()::date, 'Rozbiór ćwiartek kurczaka - Golden Path')
  RETURNING id INTO v_decomp_order_id;
  
  INSERT INTO t_production_inputs (production_order_id, batch_id, product_id, weight, direction) VALUES (v_decomp_order_id, v_raw_batch_id, v_raw_chicken_id, 5000, 'input');
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage, created_at) VALUES (v_decomp_order_id, v_meat_batch_id, v_semi_meat_id, 3000, 'Decomposition', NOW()) RETURNING id INTO v_decomp_log_id;
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage, created_at) VALUES (v_decomp_order_id, v_bones_batch_id, v_waste_bones_id, 1900, 'Decomposition', NOW());

  -- Stage 3: Processing (110% yield)
  ...
  INSERT INTO t_production_inputs (production_order_id, batch_id, product_id, weight, direction) VALUES (v_processing_order_id, v_meat_batch_id, v_semi_meat_id, 3000, 'input');
  ...
  INSERT INTO t_production_inputs (production_order_id, batch_id, product_id, weight, direction) VALUES (v_assembly_order_id, v_masa_batch_id, v_semi_masa_id, 3300, 'input');
  ...
  INSERT INTO t_production_kebab_variants (production_log_id, variant_name, variant_weight, quantity, total_weight) VALUES (v_assembly_log_id, 'Kebab 10kg', 10, 30, 300);
  INSERT INTO t_production_kebab_variants (production_log_id, variant_name, variant_weight, quantity, total_weight) VALUES (v_assembly_log_id, 'Kebab 15kg', 15, 100, 1500);
  INSERT INTO t_production_kebab_variants (production_log_id, variant_name, variant_weight, quantity, total_weight) VALUES (v_assembly_log_id, 'Kebab 20kg', 20, 75, 1500);
  ...
  INSERT INTO t_production_inputs (production_order_id, batch_id, product_id, weight, direction) VALUES (v_freezing_order_id, v_kebab_batch_id, v_finished_kebab_15_id, 3300, 'input');
  ...
  v_result := jsonb_build_object(
    ...
    'test_date', NOW(),
    'summary', jsonb_build_object('total_input_kg', 5000, 'decomposition_yield_pct', 60, 'processing_yield_pct', 110, 'meat_produced_kg', 3000, 'waste_kg', 1900, 'masa_produced_kg', 3300, 'finished_goods_kg', 3300, 'overall_yield_pct', 66),
    'products_by_category', jsonb_build_object('RawMeat', 1, 'SemiFinished', 2, 'FinishedGood', 3, 'Waste', 1, 'Spice', 1, 'Additive', 2, 'total', 10),
    'orders_by_type', jsonb_build_object('Decomposition', 1, 'Processing', 1, 'Assembly', 1, 'Freezing', 1, 'total', 4),
    'recipe', jsonb_build_object('id', v_recipe_id, 'name', 'Masa kebabowa standard', 'base_product', 'Mięso z kurczaka (SemiFinished)', 'output_product', 'Masa kebabowa masowana (SemiFinished)', 'yield_percent', 110, 'ingredients_count', 3),
    'kebab_variants', jsonb_build_object('Kebab_10kg', jsonb_build_object('quantity', 30, 'total_kg', 300), 'Kebab_15kg', jsonb_build_object('quantity', 100, 'total_kg', 1500), 'Kebab_20kg', jsonb_build_object('quantity', 75, 'total_kg', 1500), 'total_sticks', 205, 'total_kg', 3300),
    'traceability', jsonb_build_object('raw_batch_id', v_raw_batch_id, 'meat_batch_id', v_meat_batch_id, 'masa_batch_id', v_masa_batch_id, 'kebab_batch_id', v_kebab_batch_id, 'bones_batch_id', v_bones_batch_id, 'raw_batch_number', TO_CHAR(NOW(), 'YYMMDD') || '/KTF/001', 'kebab_batch_number', TO_CHAR(NOW(), 'YYMMDD') || '/KTF/005'),
    'logistics', jsonb_build_object('pallets_created', 5, 'shipment_id', v_shipment_id, 'shipment_number', 'WZ/' || TO_CHAR(NOW(), 'YYMMDD') || '/001', 'shipment_status', 'Shipped')
  );
