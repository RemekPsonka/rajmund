...
BEGIN
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage) VALUES (v_decomp_order_id, v_meat_batch_id, v_semi_meat_id, 3000, 'Decomposition');
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage) VALUES (v_decomp_order_id, v_bones_batch_id, v_waste_bones_id, 1900, 'Decomposition');
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage, recipe_id) VALUES (v_processing_order_id, v_masa_batch_id, v_semi_masa_id, 3300, 'Massaging', v_recipe_id);
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage) VALUES (v_assembly_order_id, v_kebab_batch_id, v_finished_kebab_15_id, 3300, 'Stacking') RETURNING id INTO v_assembly_log_id;
  ...
  INSERT INTO t_production_logs (production_order_id, output_batch_id, product_id, weight_net, process_stage, freezing_started_at, freezing_completed_at, freezing_duration_minutes) VALUES (v_freezing_order_id, v_kebab_batch_id, v_finished_kebab_15_id, 3300, 'ShockFreezing', NOW() - INTERVAL '4 hours', NOW(), 240);
