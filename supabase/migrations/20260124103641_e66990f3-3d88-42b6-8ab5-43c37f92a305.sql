...
BEGIN
  -- ============================================
  -- CLEANUP - correct order based on actual FK constraints
  -- ============================================
  
  -- 1. Delete shipment items first (references shipments and handling_units)
  ...
  -- 5. Delete production logs (references production_orders)
  ...
  -- 6. Delete production inputs (references production_orders)
  ...
  -- 7. Delete production tasks (uses production_order_id - confirmed from schema)
  ...
  -- 9. Delete batches (references products and storage_locations)
  ...
  -- 10. Delete recipe ingredients (references recipes)
  ...
  -- Production logs for decomposition
  ...
  -- ============================================
  -- STAGE 3: PROCESSING/MASSAGING (110% yield)
  -- ============================================
  ...
  -- Output batch: 3300kg masa (110% yield from recipe)
  INSERT INTO t_batches (
    product_id, internal_batch_number,
    current_quantity, initial_quantity, status, production_date, expiration_date,
    location_id
  ...
  VALUES (
    ...
    'Massaging', NOW(), v_recipe_id, 3300, 0, 0
  )
  RETURNING id INTO v_processing_log_id;

  -- ============================================
  -- STAGE 4: ASSEMBLY (Kebab sticks)
  -- ============================================
  ...
  -- Output batch for finished kebabs
  INSERT INTO t_batches (
    product_id, internal_batch_number,
    current_quantity, initial_quantity, status, production_date, expiration_date,
    location_id
  ...
  -- Kebab variants: 30x10kg + 100x15kg + 75x20kg = 300 + 1500 + 1500 = 3300kg
  ...
  -- ============================================
  -- STAGE 6: PALLETIZATION (5 pallets)
  -- ============================================
  ...
  v_result := jsonb_build_object(
    'success', true,
    'message', 'Pełna symulacja Golden Path zakończona pomyślnie',
    'test_date', NOW(),
    ...
    'employees', jsonb_build_object(
      'note', 'Symulacja nie tworzy pracowników - używa istniejących lub NULL'
    ),
