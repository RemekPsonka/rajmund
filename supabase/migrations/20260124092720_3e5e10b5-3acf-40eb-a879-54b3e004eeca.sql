...
BEGIN
  -- ============================================
  -- STEP 0: CLEAN DATABASE (only existing tables)
  -- ============================================
...
6. Kontrola jakości przed wyładunkiem',
  ...
  -- ============================================
  -- STEP 4: CREATE BATCHES AND ORDERS
  -- Note: We create batches directly without deliveries for simplicity
  -- ============================================
  
  -- Create raw material batch
  INSERT INTO t_batches (company_id, facility_id, product_id, internal_batch_number, supplier_batch_number, quantity, unit, production_date, expiry_date, status)
  VALUES (
    v_company_id, 
    v_facility_id, 
    v_raw_chicken_id, 
  ...
  INSERT INTO t_batches (company_id, facility_id, product_id, internal_batch_number, quantity, unit, production_date, expiry_date, status)
  VALUES (
    v_company_id, 
    v_facility_id, 
    v_chicken_meat_id, 
